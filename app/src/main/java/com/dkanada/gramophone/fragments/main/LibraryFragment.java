...
public class LibraryFragment extends AbsMainActivityFragment implements ViewPager.OnPageChangeListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private boolean handleGridSizeMenuItem(@NonNull AbsLibraryPagerRecyclerViewCustomGridSizeFragment fragment, @NonNull MenuItem item) {
        ...
        if (_id == R.id.action_grid_size_1) {
            gridSize = 1;
        } else if (_id == R.id.action_grid_size_2) {
            gridSize = 2;
        } else if (_id == R.id.action_grid_size_3) {
            gridSize = 3;
        } else if (_id == R.id.action_grid_size_4) {
            gridSize = 4;
        } else if (_id == R.id.action_grid_size_5) {
            gridSize = 5;
        } else if (_id == R.id.action_grid_size_6) {
            gridSize = 6;
        } else if (_id == R.id.action_grid_size_7) {
            gridSize = 7;
        } else if (_id == R.id.action_grid_size_8) {
            gridSize = 8;
        }
    ...
    private boolean handleSortMethodMenuItem(@NonNull AbsLibraryPagerRecyclerViewCustomGridSizeFragment fragment, @NonNull MenuItem item) {
        ...
        int _id = item.getItemId();
        if (_id == R.id.action_sort_method_name) {
            sortMethod = SortMethod.NAME;
        } else if (_id == R.id.action_sort_method_album) {
            sortMethod = SortMethod.ALBUM;
        } else if (_id == R.id.action_sort_method_artist) {
            sortMethod = SortMethod.ARTIST;
        } else if (_id == R.id.action_sort_method_year) {
            sortMethod = SortMethod.YEAR;
        } else if (_id == R.id.action_sort_method_added) {
            sortMethod = SortMethod.ADDED;
        } else if (_id == R.id.action_sort_method_random) {
    ...
    private boolean handleSortOrderMenuItem(@NonNull AbsLibraryPagerRecyclerViewCustomGridSizeFragment fragment, @NonNull MenuItem item) {
        ...
        int _id = item.getItemId();
        if (_id == R.id.action_sort_order_ascending) {
            sortOrder = SortOrder.ASCENDING;
        } else if (_id == R.id.action_sort_order_descending) {
